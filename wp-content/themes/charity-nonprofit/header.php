<?php
/**
 * Header file for the Charity Nonprofit WordPress theme.
 * @package Charity Nonprofit
 * @since 1.0.0
 */
?><!DOCTYPE html>
<html class="no-js" <?php language_attributes(); ?>>
  <?php if( get_theme_mod('charity_nonprofit_theme_loader',false) == 1 ) { ?>
    <div class="preloader">
      <div class="loader">
        <div></div>
        <div></div>
...
<a class="skip-link screen-reader-text" href="#site-content"><?php esc_html_e('Skip to the content', 'charity-nonprofit'); ?></a>
