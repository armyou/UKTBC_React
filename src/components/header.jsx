    ...
    return (
        <>
            <div className="header col-sm-12">
                <img src={logo} alt="" className="col-sm-1 logo" />
                <ul className="nav-list">
                    ...
                    <li>
                        <NavLink className="nav-item" to={"/contact-us"}>Contacts</NavLink>
                    </li>
                </ul>
                <Button type="primary" shape='round' className='cta' onClick={() => navigate('/donate-now')}>Donate Now</Button>
            </div>
        </>
    )
}
