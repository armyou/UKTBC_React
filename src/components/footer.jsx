        ...
        <>
            <div className="footer col-sm-12">
                <div className="brand col-sm-3">
                    ...
                    <Button type="primary" shape='round' className='cta col-sm-8' onClick={() => navigate('/donate-now')}>Donate Now</Button>
                </div>
                ...
                <div className="quick-links col-sm-3">
                    ...
                    <div className="footer-links">
                        <a href="https://www.linkedin.com" target="_blank" rel="noopener noreferrer" className="paragraph">
                            <FaLinkedin size={20}/> LinkedIn
                        </a>
                        <a href="https://www.youtube.com" target="_blank" rel="noopener noreferrer" className="paragraph">
                            <FaYoutube size={20} /> YouTube
                        </a>
                        <a href="https://www.facebook.com" target="_blank" rel="noopener noreferrer" className="paragraph">
                            <FaFacebook size={20}/> Facebook
                        </a>
                        <a href="https://www.instagram.com" target="_blank" rel="noopener noreferrer" className="paragraph">
